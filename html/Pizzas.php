...
<html>
	<head>
		<title>Pizzas Agregadas</title>
		<meta charset="utf-8">
		<link rel="stylesheet" type="text/css" href="../librerias/css/Pizzas.css">
	...
	<body>
		...
		<article>
			<h1 id="AR">Pizzas Agregadas</h1>
			<div id="TablaReser">
				<table border="1" cellpadding="5" cellspacing="1" id="TablaRe">
					<thead id="TabR">
						<tr>
							<th id="MenuI">Nombre</th>
							<th id="MenuI1">Foto</th>
							<th id="MenuI2">Descripción</th>
							<th id="MenuI3">Precio</th>
						</tr>
					</thead>
					<tbody id="TabR2">
						<?php
						...
						?>
							<tr>
								...
								<td>
									<div id="ImgP">
										<img id="ImgPA" src="../DescargarImagenes/<?php echo $fila['foto']; ?>" width="280" height="200">
									</div>
								</td>
